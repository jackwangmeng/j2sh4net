...
<div class="row search-form-default">
    <div class="col-md-12">
        <form action="${ctx}/admin/competitionlist/competition-list-list?readed=${param.readed}" method="get"
              class="form-inline form-validation form-search-init control-label-sm"
              data-div-search=".competitionlist-competition-list-List">
            <div class="btn-group">
                <a class="btn btn-default ${empty param.readed?'active':''}" href='javascripts:;'
                   rel='address:/admin/competitionlist/competition-list|竞赛列表'>全部</a> <a
                    class="btn btn-default ${param.readed=='no'?'active':''}" href='javascripts:;'
                    rel='address:/admin/competitionlist/competition-list?readed=no|未读竞赛列表'>未读</a> <a
                    class="btn btn-default ${param.readed=='yes'?'active':''}" href='javascripts:;'
                    rel='address:/admin/competitionlist/competition-list?readed=yes|已读竞赛列表'>已读</a>
            </div>
...
<div class="competitionlist-competition-list-List"></div>
</body>
</html>